...
<script type="text/javascript">
  ...
  (function() {
    var u="//webanalytics.ptdl.tk/";
    _paq.push(['setTrackerUrl', u+'matomo.php']);
    _paq.push(['setSiteId', 'bid.ptdl.tk']);
...
var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0];
g.type='text/javascript'; g.async=true; g.src='https://matomo.ptdl.tk/js/container_e1cF18hO.js'; s.parentNode.insertBefore(g,s);
...
@yield('script')
@stack('scripts')
<script src="https://automarketing.ptdl.tk/focus/2.js" type="text/javascript" charset="utf-8" async="async"></script>
</body>
</html>

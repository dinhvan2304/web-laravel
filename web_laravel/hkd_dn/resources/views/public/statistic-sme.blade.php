...
@section('content')
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Thống kê danh sách doanh nghiệp theo địa bàn</h1>
          </div>
          <div class="col-sm-6">
...
<script>
  ...
  $.getJSON("{{url('/api/statistic-smes')}}")
          ...
          if (e.area === 'data') {
            ...
            drillDownDataSource = new DevExpress.data.DataSource({
              ...
              load: function(loadOptions) {
                  ...
                  $.getJSON(`{{url('/api/statistic-smes-list')}}?tinh=${tinh}&huyen=${huyen}&xa=${xa}`, params)
                      .done(function(result) {
                          console.log(result);
